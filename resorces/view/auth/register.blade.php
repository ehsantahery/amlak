                                ...
                                <div class="card-body pt-0">
                                    <form action="<?= route('auth.register') ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-label-group">
                                            <input type="text" name="first_name" id="first_name" class="form-control" placeholder="نام" >
                                            <label for="first_name">نام</label>
                                        </div>
                                        <div class="form-label-group">
                                            <input type="text" name="last_name" id="last_name" class="form-control " placeholder="نام خانوادگی" >
                                        ...
                                        <a href="<?= route('auth.login') ?>" class="btn btn-outline-primary float-left btn-inline mb-50">ورود</a>
